...
from ._vnccs_compat import load_utils, load_vnccs_utils

_vnccs_utils_mod = load_utils()
load_character_info = _vnccs_utils_mod.load_character_info
ensure_character_structure = _vnccs_utils_mod.ensure_character_structure
EMOTIONS = _vnccs_utils_mod.EMOTIONS
MAIN_DIRS = _vnccs_utils_mod.MAIN_DIRS
save_config = _vnccs_utils_mod.save_config
build_face_details = _vnccs_utils_mod.build_face_details
generate_seed = _vnccs_utils_mod.generate_seed
dedupe_tokens = _vnccs_utils_mod.dedupe_tokens
apply_sex = _vnccs_utils_mod.apply_sex
append_age = _vnccs_utils_mod.append_age
load_config = _vnccs_utils_mod.load_config
age_strength = _vnccs_utils_mod.age_strength
list_characters = _vnccs_utils_mod.list_characters
character_dir = _vnccs_utils_mod.character_dir
base_output_dir = _vnccs_utils_mod.base_output_dir
sheets_dir = _vnccs_utils_mod.sheets_dir
faces_dir = _vnccs_utils_mod.faces_dir
normalize_hair_tags = _vnccs_utils_mod.normalize_hair_tags
